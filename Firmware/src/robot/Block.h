...
public:
    ...
    Block(Block const&) = delete;             // Copy construct
    Block(Block&&) = delete;                  // Move construct
    Block& operator=(Block const&) = delete;  // Copy assign
    Block& operator=(Block &&) = delete;      // Move assign
